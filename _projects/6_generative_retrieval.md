...
img: assets/img/generative_recall.png
importance: 1
category: industry
---
...
During my internship with the Commerce Ads Technology team at **ByteDance**, I worked on a generative retrieval branch for large-scale recommendation over a candidate space of billions of items, built on hierarchical Semantic IDs and LLMs.
